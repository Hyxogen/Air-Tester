...
#define AIR_EXPECT_TRUE(condition, file, line) AIR_TEST_BOOLEAN_(condition, #condition, true, false, file, line);
#define AIR_EXPECT_FALSE(condition, file, line) AIR_TEST_BOOLEAN_(condition, #condition, false, true, file, line);
